...
// 	// Instantiate the generic function atdb.GetAllDoc
// 	atdb.GetAllDoc = func(dbConn interface{}, collection string, filter interface{}) ([]model.QrHistory, error) {
// 		return originalGetAllDoc(dbConn, collection, filter)
// 	}
