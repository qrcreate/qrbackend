...
// TokenService adalah struct yang memiliki dependensi Decoder
type TokenService struct {
	Decoder watoken.TokenDecoder
}

// PostQRHistory adalah handler untuk menambahkan data QR history
func (s *TokenService) PostQRHistory(respw http.ResponseWriter, req *http.Request) {
	payload, err := s.Decoder.Decode(config.PublicKeyWhatsAuth, at.GetLoginFromHeader(req))
	if err != nil {
	...
	// Mengambil data user berdasarkan payload
